          ...
          >
            {({ values, isSubmitting }) => (
              <Form>
                <FieldArray name="posts">
                  {({ push, remove }) => (
                    <div>
                      ...
                      <Button
                        variant="contained"
                        style={{ backgroundColor: 'rgba(0, 100, 0, 0.7)', color: 'white' }}
                ...
                <Button type="submit" variant="contained" style={{ backgroundColor: 'rgba(0, 100, 0, 0.7)', color: 'white' }} disabled={isSubmitting}>Save</Button>
              </Form>
            )}
          </Formik>
        </Box>
